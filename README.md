...
| 用户ID | 用户名 | 测试用密码 (明文) | 邮箱 | 手机号 | 注册时间 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | `test123` | `123456` | test123@example.com | 13800138000 | 2025-12-05 14:30:41 |
| 2 | `杜一帆` | '123'| 3440316133@qq.com | 18739619331 | 2025-12-05 20:49:36 |
| 3 | `张三` | `123456` | zhangsan123@example.com | 13800138000 | 2025-12-05 21:25:26 |
